...
var ctx = canvas.getContext("2d"); //We use this ctx to do all of our drawing in 2d
var width = 800;
var height = 600;
...
function drawPoint(x, y, color) {
    ctx.fillStyle = color;     //Fill a circle with a color
    y = Math.abs(y - height);  //We are flipping the y axis here
    ctx.beginPath();
